...
if currency_convertor:
    ...
    target_currency = input('Введите код валюты для пересчета в USD - usd, eur, uah, chf, byn, rub: ')
    target_currency_amount = int(input('Введите сумму : '))
