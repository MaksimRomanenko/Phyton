...
print('Result_sum is         ', result_sum, '    ', type(result_sum))
...
print('Result_subtr is      ', result_subtr, '    ', type(result_subtr))
...
print('Result_multi is      ', result_multi, '    ', type(result_multi))
...
print('Result_exp is      ', result_exp, '    ', type(result_exp))
...
print('Result_m_exp is    ', result_m_exp, '  ', type(result_m_exp))
...
print('Result_s_root is    ', result_s_root, '    ', type(result_s_root))

# 15. Создать переменную result_m_s_root в которой вы найдёте
#     квадратный корень любой из переменной item используя библиотеку math.
result_m_s_root = math.sqrt(item_1)

# 16. Вывести result_m_s_root в консоль.
print('Result_m_s_root is  ', result_m_s_root, '    ', type(result_m_s_root))

# 17. Создать переменную result_mp_s_root в которой вы найдёте квадратный
# корень любой из переменной item используя библиотеку math используя метод pow.
result_mp_s_root = math.pow(item_1, 0.5)

# 18. Вывести result_mp_s_root в консоль.
print('Result_mp_s_root is ', result_mp_s_root, '    ', type(result_mp_s_root))
...
print('Result_division is  ', result_division, '   ', type(result_division))
...
print('Result_m_floor is     ', result_m_floor, '    ', type(result_m_floor))
...
print('Result_m_ceil is      ', result_m_ceil, '    ', type(result_m_ceil))
...
print('Result_int is         ', result_int, '    ', type(result_int))
...
print('Rslt_no_div_loss is   ', result_no_division_loss, '    ', type(result_no_division_loss))
...
print('Rslt_div_loss is      ', result_division_loss, '    ', type(result_division_loss))
...
print('Rslt_add_assign is   ', item_3, '    ', type(item_3))
...
# 46. Присвоить остаток от деления item_3 на 2
item_3 %= 2
...
print('b_item_relult_sum is   ', b_item_relult_sum, '   ', type(b_item_relult_sum))
...
print('b_item_rslt_subtr is   ', b_item_relult_subtr, '   ', type(b_item_relult_subtr))
...
print('b_item_rslt_multi is   ', b_item_relult_multi, '   ', type(b_item_relult_multi))
...
# print('b_item_relult_div is   ', b_item_relult_division, '   ', type(b_item_relult_division))
...
print('b_item_1_int is        ', b_item_1_int, '   ', type(b_item_1_int))
...
print('b_item_2_int is        ', b_item_2_int, '   ', type(b_item_2_int))
